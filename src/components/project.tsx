...
export default function Project({ title, description, tags, imageUrl }: ProjectProps) {
    ...
    >
        <article className=" bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[20rem] group-even:pl-6 rounded-lg hover:shadow-sm hover:bg-gray-200 transition">
        <div className="pb-7 pt-4 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full group-even:ml-[20rem]">
        ...
        <Image
        className="absolute top-8 -right-40 w-[28.25rem] rounded-t-lg shadow-2xl group-hover:-translate-x-3 group-hover:translate-y-3 
