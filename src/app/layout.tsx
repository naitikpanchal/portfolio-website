  ...
  return (
    <html lang="en" className="!scroll-smooth">
      {/* <body className={`${inter.className} bg-slate-100 text-gray-950 relative pt-28 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}>
        <div className="bg-[#dbd7fb] absolute -z-10 h-[35rem] w-[47.50rem] rounded-full top-[-5rem] blur-[10rem] dark:bg-[#946263]"></div>
        <div className="bg-[#fbe2e3] absolute -z-10 h-[35rem] w-[47.50rem] right-0 top-[-6rem] rounded-full blur-[10rem] dark:bg-[#676394]"></div> */}
        <body
